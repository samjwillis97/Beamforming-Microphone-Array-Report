...
\subsection{Site Testing} \label{sec:Site Testing}
    ...
    \begin{figure} [H]
        \centering
        \includegraphics[keepaspectratio, width = 0.95\textwidth]{Figures/U5_LPB.png}
    ...
    \begin{figure} [H]
        \centering
        \includegraphics[keepaspectratio, width = 0.95\textwidth]{Figures/U6_LPB.png}
    ...
    \begin{figure} [H]
        \centering
        \begin{tabular}{c}
            \subfloat[Problem Unit Bearing 8]{\includegraphics[keepaspectratio, width = 0.95\textwidth]{Figures/U5Bearing89_Period.png}} \\
            \subfloat[Good Unit Bearing 8]{\includegraphics[keepaspectratio, width = 0.95\textwidth]{Figures/U6Bearing89_Period.png}}
        \end{tabular}
    ...
    \begin{figure} [H]
        \centering
        \begin{tabular}{cc}
             \subfloat[DAS Algorithm]{\includegraphics[keepaspectratio, width = 0.4\textwidth]{Figures/U5Cyl_DAS.png}}&
             \subfloat[MUSIC Algorithm 2kHz - 3kHz]{\includegraphics[keepaspectratio, width = 0.4\textwidth]{Figures/U5Cyl_MUSIC.png}}
        \end{tabular}
    ...
    Looking at the signals in Figure \ref{fig:U5 Signal} and \ref{fig:U6 Signal} it would be assumed that the signals are indeed coming from directly in the centre of the array as all the signals are arriving at the same time, though due to the many different locations and the signal being the same at all locations that the sound isn't coming from a point directly in the centre of the array, there are two main thoughts as to the reasons this is happening. The first theory is that the cylinder itself and the bearing casings are acting as one large loudspeaker, this would be amplifying the noise over the whole turbine, this would fit the signal being synchronised on all microphones. The second theory is that due to the environment of the power station that the reverberation off of the surrounding structure and plant is causing it to seem like the signal is coming from all directions at once and hence the microphone signals all being synchronised.
