...
\subsection{Site Testing} \label{sec:Site Testing}
    ...
    \begin{figure} [H]
        \centering
        \begin{tabular}{c}
            \subfloat[Problem Unit Bearing 8 Single Period of Time Waveform]{\includegraphics[keepaspectratio, width = \textwidth]{Figures/U5Bearing89_Period.png}} \\
            \subfloat[Good Unit Bearing 8 Single Period of Time Waveform]{\includegraphics[keepaspectratio, width = \textwidth]{Figures/U6Bearing89_Period.png}}
        \end{tabular}
    ...
    \hl{first compare sounds to work out differences}
    \hl{compared to previous tests signals were very significantly louder}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newpage
